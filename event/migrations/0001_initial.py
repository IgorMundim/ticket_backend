    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='event.address')),
                ('categories', models.ManyToManyField(blank=True, null=True, to='event.category')),
            ],
            options={
                'verbose_name': 'event',
